...
const en: Record<string, string> = {
  ...
  'command.configureEndpoint.title': 'SavicLabs: Configure Backends',
  'command.configureEndpoint.prompt': 'Select or add an AI backend',
  'command.configureEndpoint.placeholder': 'http://127.0.0.1:18080/v1',
  'command.configureEndpoint.saved': 'Backend configuration saved. Run "Refresh Models" to discover models.',
  'command.configureEndpoint.empty': 'URL cannot be empty.',
  'command.checkBackends.title': 'SavicLabs: Check Backend Health',
  'command.checkBackends.none': 'No backends configured. Run "Configure Endpoint" first.',
